// ======================================================================
// \title  SimFSWTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SIMFSW_SIMFSWTOPOLOGY_HPP
#define SIMFSW_SIMFSWTOPOLOGY_HPP
// Included for access to SimFSW::TopologyState and SimFSW::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SimFSW/Top/SimFSWTopologyDefs.hpp>

// Remove unnecessary SimFSW:: qualifications
using namespace SimFSW;
namespace SimFSW {
/**
 ...
 * SimFSW::TopologyState see: SimFSWTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SimFSW::TopologyState see: SimFSWTopologyDefs.hpp.
 *
