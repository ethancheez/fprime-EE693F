// ======================================================================
// \title  SimFSWTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <SimFSW/Top/SimFSWTopologyAc.hpp>
#include <SimFSW/Top/SimFSWPacketsAc.hpp>
...
// The reference topology divides the incoming clock signal (1Hz) into sub-signals: 1/100Hz, 1/1000Hz, and 1/10000Hz
NATIVE_INT_TYPE rateGroupDivisors[Svc::RateGroupDriver::DIVIDER_SIZE] = {100, 1000, 10000};
...
// Public functions for use in main program are namespaced with deployment name SimFSW
namespace SimFSW {
