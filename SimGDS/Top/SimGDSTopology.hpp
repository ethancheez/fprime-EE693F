// ======================================================================
// \title  SimGDSTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SIMGDS_SIMGDSTOPOLOGY_HPP
#define SIMGDS_SIMGDSTOPOLOGY_HPP
// Included for access to SimGDS::TopologyState and SimGDS::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SimGDS/Top/SimGDSTopologyDefs.hpp>

// Remove unnecessary SimGDS:: qualifications
 ...
 * SimGDS::TopologyState see: SimGDSTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SimGDS::TopologyState see: SimGDSTopologyDefs.hpp.
 *
